# ⚡ NotebookLM: Especialista em normas técnicas de instalações elétricas em baixa tensão segundo a norma NBR-5410
...
## 📚 Fontes de Consulta (Base de Conhecimento)
O "conhecimento" deste notebook é extraído das 4 principais fontes bibliográficas disponíveis neste repositório:
...
2.  Carregue os arquivos disponíveis na pasta `/documentos` deste repositório.
3.  Faça perguntas como: *"Qual a taxa de ocupação máxima para três cabos em um eletroduto?"* ou *"Quais os requisitos para o esquema de aterramento TN-S?"*.
